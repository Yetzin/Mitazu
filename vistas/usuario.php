...
<div class="mitad"><h1>Hola, bienvenido a Mitazu Agenda.</h1><div class="linea_pre_1"></div></div>
<div class="sub_menu">
	<div class="con_sub">
		<div class="msg_tip">
			<div class="div_n">
				<h3 class="msg_text">Fácil de usar</h3>
			</div>
			<div class="div_n">
	...
	<div class="con_sub">
		<div class="msg_tip">
			<div class="div_n">
				<h3 class="msg_text">¿Necesitas ayuda?</h3>
			</div>
			<div class="div_n">
	...
	<div class="con_sub">
		<div class="msg_tip">
			<div class="div_n">
				<h3 class="msg_text">¿Quieres empezar?</h3>
			</div>
			<div class="div_n">
				<p class="msg_text">Puedes crear tu cuenta de manera rápida y sencilla.</p>
			</div>
			<div class="div_n">
				<a class="enl_ini" onclick="registro();"><b id="mantener">Click aquí para ir >></b></a>
			</div>
		</div>
	</div>
	<a onclick="alert('Hola');">
		<div class="flechita_uwu_1"></div>
		<div class="flechita_uwu_2"></div>
		<div class="flechita_uwu_3"></div>
	</a>
</div>
<br>
<br>
